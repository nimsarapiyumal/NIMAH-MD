...
const ownerNumber = ['94729670408','94763165605']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/auth_info_baileys/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.split("𝐍𝐈𝐌𝐀𝐇 𝐌𝐃=")[1];
...
console.log("Connecting 𝐍𝐈𝐌𝐀𝐇 𝐌𝐃 Bot.....🔥");
...
let up = `*Connecting 𝐍𝐈𝐌𝐀𝐇 𝐌𝐃 Multidevice Whatsapp Bot ...💾*


*😈 : 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐂𝐇𝐀𝐍𝐍𝐄𝐋*
*╭┈───────────╴╴╴•⟢*
*│https://whatsapp.com/channel/0029Vb6EsZf96H4X4Jy6Uj1R*
*╰┈───────────╴╴╴•⟢*
*😈 : 𝐂𝐎𝐍𝐓𝐀𝐂𝐓*
*╭┈───────────╴╴╴•⟢*
*│wa.me/94729670408*
...
conn.sendMessage(conn.user.id,{ image: { url: `https://i.ibb.co/ZzwhmX01/SulaMd.jpg` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("94729670408")){
if(isReact) return
m.react("👨‍💻")
}
