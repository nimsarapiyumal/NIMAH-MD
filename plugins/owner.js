...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerNumber = '+94729670408'; // Replace this with the actual owner number
        const ownerName = 'NIMAH MD'; // Replace this with the owner's name
        ...
        await conn.sendMessage(from, {
            text: `MD`,
            contextInfo: {
                mentionedJid: [ownerNumber.replace('94729670408') + '+94729670408@s.whatsapp.net'], // Mention the owner
